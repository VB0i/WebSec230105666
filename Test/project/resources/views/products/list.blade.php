...
<form>
    <div class="row">
        ...
        <div class="col col-sm-1">
            <button type="reset" onclick="window.location.href='{{ route('products_list') }}'" class="btn btn-danger">Reset</button>
        </div>
    </div>
</form>
        ...
        <div class="card-body">
            <div class="row">
                <div class="col col-sm-12 col-lg-4">
                    ...
                    <img src="{{ $product->photo ? asset('images/' . $product->photo) : asset('images/no-image.jpg') }}" class="img-thumbnail" alt="{{$product->name}}" width="100%">
                </div>
